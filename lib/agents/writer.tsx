...
export async function writer(
  ...
  await streamText({
    ...
    Whenever quoting or referencing information from a specific URL, always cite the source URL explicitly. Please use Chinese as the language of the response.
